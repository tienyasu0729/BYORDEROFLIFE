...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=DESKTOP-GEUNOKJ\\SQLEXPRESS;Database=test_DBFirst_ASP;TrustServerCertificate=true;Trusted_Connection=SSPI;Encrypt=false;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Car>(entity =>
        {
            entity.HasKey(e => e.IdCar).HasName("PK__car__D54686DCA94486BA");

            entity.ToTable("car");

            entity.HasIndex(e => e.NameCar, "UQ__car__30D6AB00653B76C3").IsUnique();
            ...
            entity.HasOne(d => d.IdColorNavigation).WithMany(p => p.Cars)
                ...
                .HasConstraintName("FK__car__id_color__145C0A3F");
        });

        modelBuilder.Entity<Colord>(entity =>
        {
            entity.HasKey(e => e.IdColor).HasName("PK__colord__7CF2AF03380B7B85");

            entity.ToTable("colord");

            entity.HasIndex(e => e.Color, "UQ__colord__900DC6E9767F96C5").IsUnique();
