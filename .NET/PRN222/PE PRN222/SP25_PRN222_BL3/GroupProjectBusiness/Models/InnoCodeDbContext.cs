...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-F389RI7;Database=InnoCodeCamp2025;User Id=tien;Password=123456;TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Project>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Projects__3214EC27D083D1EA");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Scores__3214EC27533F9236");
            ...
            entity.HasOne(d => d.Lecturer).WithMany(p => p.Scores)
                ...
                .HasConstraintName("FK__Scores__Lecturer__33D4B598");

            entity.HasOne(d => d.Project).WithMany(p => p.Scores)
                .HasForeignKey(d => d.ProjectId)
                .HasConstraintName("FK__Scores__ProjectI__32E0915F");
        });

        modelBuilder.Entity<Team>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Teams__3214EC27827D9443");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__users__3214EC27B1A220A6");

            entity.ToTable("users");

            entity.HasIndex(e => e.Email, "UQ__users__A9D10534EEC1ADD6").IsUnique();
