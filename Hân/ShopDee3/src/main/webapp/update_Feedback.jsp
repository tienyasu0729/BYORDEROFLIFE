    ...
    <section class="bg0 p-t-104 p-b-116">
        <div class="container" style="display: flex; justify-content: center; align-items: center;">
            <div class="size-210 bor10 p-lr-70 p-t-55 p-b-30 p-lr-15-lg w-full-md" style="width: 100%; max-width: 600px; display: flex; flex-direction: column; align-items: center;">
                <form id="review-form" style="width: 100%; text-align: center;">
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent" style="margin-bottom: 20px; position: relative; width: 100%;">
                        <input id="username" class="stext-111 cl2 plh3 size-116 p-l-62 p-r-30" type="text" name="username" placeholder="Ngoc Han" style="width: 100%; padding: 10px; border-radius: 8px; border: 1px solid #ccc;">
                    </div>
                    ...
                    <div class="bor8 m-b-20 how-pos4-parent" style="margin-bottom: 20px; position: relative; width: 100%;">
                        ...
                        <!-- Ph?n ch?n sao -->
                        <div class="rating" style="display: flex; justify-content: center; margin-bottom: 20px;">
