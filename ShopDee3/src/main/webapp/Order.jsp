        ...
        <header class="header-v4">
            ...
            <div class="menu-mobile">
                ...
                <ul class="main-menu-m">
                    ...
                    <li>
                        <a href="shoping-cart.jsp" class="label1 rs1" data-label1="hot"
                           >Features</a
                        >
                    </li>
                                    ...
                                    <tr>
                                        ...
                                        <td class="column-4">
                                            <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                ...
                                                <input id="quantityInput" class="mtext-104 cl3 txt-center num-product" type="number" name="num-product-1" value="<%= item.getQuantity()%>" min="1" />
                        ...
                        <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm" >
                            ...
                            <!--                            <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                                                            ...
                                                            <div class="container form-container">
                                                                <h5 class="text-center">Nhập thông tin người nhận</h5>
                                                                <form action="">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control" id="house-number" placeholder="Nhập số nhà">
                                                                    </div>
                                                                    <div class="form-group" style="padding-left: 10px;" >
                                                                        ...
                                                                        <div style="padding-left: 30px;">
                                                                            ...
                                                                            <div class="form-check" >
                                                                                ...
                                                                                <label class="form-check-label" for="cashOnDelivery">Trả sau (COD)</label>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </form>
