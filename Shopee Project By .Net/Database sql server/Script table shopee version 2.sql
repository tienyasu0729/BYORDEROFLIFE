...
CREATE TABLE main_account (
    ...
    business_ID NVARCHAR(500) NOT NULL UNIQUE,
...
CREATE TABLE shop (
    ...
    shop_avatar_image NVARCHAR(500) NULL,
...
CREATE TABLE [user] (
    ...
    avatar_image NVARCHAR(500) NULL,
...
CREATE TABLE list_email_to_receive_electronic_invoices (
    ...
    email_address NVARCHAR(500) NOT NULL UNIQUE,
    id_shop INT NOT NULL,
    FOREIGN KEY (id_shop) REFERENCES shop(id_shop) ON DELETE CASCADE
);
GO
...
CREATE TABLE business_information (
    ...
    address_to_take_product NVARCHAR(100) NOT NULL,
    registered_business_address NVARCHAR(100) NOT NULL,
...
CREATE TABLE form_of_identification (
    ...
    name_form NVARCHAR(500) NOT NULL CHECK (
        name_form LIKE '%'
...
CREATE TABLE identification_shop (
    ...
    identification_number NVARCHAR(500) NOT NULL,
    identification_name NVARCHAR(500) NOT NULL,
    image_identification_front NVARCHAR(500) NOT NULL,
    image_identification_back NVARCHAR(500) NOT NULL,
...
CREATE TABLE category_attribute (
    ...
    name_attribute NVARCHAR(500) NOT NULL,
...
CREATE TABLE product (
    ...
    condition_product NVARCHAR(255) NOT NULL,
    SKU_product NVARCHAR(255) NULL,
...
CREATE TABLE image_and_short_video_product (
    ...
    folder_image NVARCHAR(500) NOT NULL,
...
CREATE TABLE classification_value (
    ...
    classification_value NVARCHAR(255),
    price INT NOT NULL,
    inventory_quantity INT DEFAULT 0,
    SKU_classification NVARCHAR(255) NULL,
...
CREATE TABLE user_identification_information (
    ...
    image_selfie NVARCHAR(500) NULL,
    image_cccd_front NVARCHAR(500) NULL,
    image_cccd_back NVARCHAR(500) NULL,
    FOREIGN KEY (id_user) REFERENCES [user](id_user) ON DELETE CASCADE
);
GO
...
CREATE TABLE user_address (
    id_user INT IDENTITY(1,1) PRIMARY KEY,
    name_address NVARCHAR(255) NOT NULL,
    phone_number NVARCHAR(15) NOT NULL,
...
CREATE TABLE coin_history (
    ...
    notification_subject NVARCHAR(255) NOT NULL,
...
CREATE TABLE shop_voucher (
    ...
    [đơn_vị_vận_chuyển] NVARCHAR(255) NOT NULL,
    [thiết_bị] NVARCHAR(255) NOT NULL
);
GO
...
CREATE TABLE user_order_pending_payment (
    ...
    note_to_seller NVARCHAR(500) NULL,
...
CREATE TABLE product_review (
    ...
    id_shop INT NOT NULL,
    id_classification_value INT NOT NULL,
    user_comment NVARCHAR(500) NOT NULL,
    shop_answer NVARCHAR(500) NULL,
    star INT NOT NULL,
